...
class FglTFImporterEdSkeletalMesh : public FglTFImporterEd
{
  ...
  public:
    static TSharedPtr<FglTFImporterEdSkeletalMesh> Get(class UFactory*         InFactory, //
                                                       UObject*                InParent,
                                                       FName                   InName,
  ...
  private:
    bool GenerateSkeletalMeshImportData(const TSharedPtr<struct FglTFImporterOptions>& InglTFImporterOptions,
                                        const std::shared_ptr<libgltf::SGlTF>&         InGlTF,
                                        const int32                                    InNodeId,
