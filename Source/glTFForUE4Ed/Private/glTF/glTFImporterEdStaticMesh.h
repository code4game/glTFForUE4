...
private:
    bool GenerateRawMesh(const TSharedPtr<struct FglTFImporterOptions> InglTFImporterOptions, const std::shared_ptr<libgltf::SGlTF>& InGlTF, const std::shared_ptr<libgltf::SMesh>& InMesh, const class FglTFBuffers& InBuffers
    ...
    bool GenerateRawMesh(const TSharedPtr<struct FglTFImporterOptions> InglTFImporterOptions, const std::shared_ptr<libgltf::SGlTF>& InGlTF, const std::shared_ptr<libgltf::SMeshPrimitive>& InMeshPrimitive, const class FglTFBuffers& InBuffers
