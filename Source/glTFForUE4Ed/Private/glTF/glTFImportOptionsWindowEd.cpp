                    ...
                    [
                        ...
                        [
                            ...
                            [
                                SNew(STextBlock)
                                    .Font(FEditorStyle::GetFontStyle("CurveEd.InfoFont"))
                                    .Text(LOCTEXT("ImportOptionsWindow_MeshScaleRatioX_Title", "X"))
                            ]
                            + SHorizontalBox::Slot()
                                .AutoWidth()
                                .Padding(2)
                            ...
                            [
                                SNew(STextBlock)
                                    .Font(FEditorStyle::GetFontStyle("CurveEd.InfoFont"))
                                    .Text(LOCTEXT("ImportOptionsWindow_MeshScaleRatioY_Title", "Y"))
                            ]
                            + SHorizontalBox::Slot()
                                .AutoWidth()
                                .Padding(2)
                            ...
                            [
                                SNew(STextBlock)
                                    .Font(FEditorStyle::GetFontStyle("CurveEd.InfoFont"))
                                    .Text(LOCTEXT("ImportOptionsWindow_MeshScaleRatioZ_Title", "Z"))
                            ]
                            + SHorizontalBox::Slot()
                                .AutoWidth()
                                .Padding(2)
